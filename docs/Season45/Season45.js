function init() {
    ...
    $('#enterBtn').click(function(e) {
		//window.location = "https://forms.gle/qo7zAxLx1kZ9B7HK9"; // Episodes 1-9
		//window.location = "https://forms.gle/sZYXowr3Ao3ahz3D7"; // Episode 10
		window.location = "https://forms.gle/f99nVyYT7JAuDsVa7"; // Episodes 11+
...
function determineWeek(responses) {
	...
	else if (submit_time <= new Date(2023,11,4,0)) { // Nov 29, 2023
        cur_vote = 10;
    }
	else if (submit_time <= new Date(2023,11,11,0)) { // Dec 6, 2023
        cur_vote = 11;
    }
	else if (submit_time <= new Date(2023,11,18,0)) { // Dec 13, 2023
        cur_vote = 12;
    }
	else if (submit_time <= new Date(2023,11,26,0)) { // Dec 20, 2023
        cur_vote = 13;
    };
    return cur_vote;
};
...
function final_eight_calc(scores, result) {
    ...
    function which_castaway(castaways){
        var sum = 0,
			bonus = 0;
        for (var i=1; i<9; i++){
            if (castaways['place_'+String([i])] === "Dee") {			// sole survivor
                sum += Math.pow(Math.abs(i-1),2.25);
				if (i===1) { bonus += 5 };
            } else if (castaways['place_'+String([i])] === "Austin") {	// runner up
                sum += Math.pow(Math.abs(i-2),2.25);
				if (i===2) { bonus += 5 };
            } else if (castaways['place_'+String([i])] === "Jake") {	// third
                sum += Math.pow(Math.abs(i-3),2.25);
				if (i===3) { bonus += 5 };
            } else if (castaways['place_'+String([i])] === "Katurah") {	// fourth
                sum += Math.pow(Math.abs(i-4),2.25);
				if (i===4) { bonus += 5 };
            } else if (castaways['place_'+String([i])] === "Julie") {	// fifth
                sum += Math.pow(Math.abs(i-5),2.25);
				if (i===5) { bonus += 5 };
            } else if (castaways['place_'+String([i])] === "Drew") {	// sixth
                sum += Math.pow(Math.abs(i-6),2.25);
				if (i===6) { bonus += 5 };
            } else if (castaways['place_'+String([i])] === "Emily") {	// seventh
                sum += Math.pow(Math.abs(i-7),2.25)
				if (i===7) { bonus += 5 };
            } else if (castaways['place_'+String([i])] === "Bruce") {	// eighth
...
function final_three_calc(scores, result) {
    var top_three = [ 'Jake', 'Austin', 'Dee'];  //top three!
	var name_ep_count = [0];
	for (var n=0; n<scores.length; n++) {
        for (var i=0; i<result.length; i++) {
			if (result[i].name === scores[n].name) {
...
var saved_responses = [
	...
	// WEEK 10
	{'name':'Christy', 'reward':'Dee', 'immunity':'Bruce', 'titleQuote':'Bruce', 'summit':'Jake', 'nudity':'No', 'idolFound':'No', 'idolPlayed':'Yes', 'shotInTheDark':'No', 'submit_time':'2023-11-29T15:57:00.000Z', 'place_1':'Austin', 'place_2':'Emily', 'place_3':'Julie', 'place_4':'Dee', 'place_5':'Jake', 'place_6':'Katurah', 'place_7':'Bruce', 'place_8':'Drew'},
	{'name':'Joe', 'reward':'Austin', 'immunity':'Austin', 'titleQuote':'Jake', 'summit':'Jake', 'nudity':'No', 'idolFound':'No', 'idolPlayed':'No', 'shotInTheDark':'No', 'submit_time':'2023-11-29T16:18:00.000Z', 'place_1':'Austin', 'place_2':'Emily', 'place_3':'Drew', 'place_4':'Julie', 'place_5':'Dee', 'place_6':'Katurah', 'place_7':'Bruce', 'place_8':'Jake'},
	{'name':'Wilson', 'reward':'Emily', 'immunity':'Austin', 'titleQuote':'Emily', 'summit':'Jake', 'nudity':'No', 'idolFound':'Yes', 'idolPlayed':'Yes', 'shotInTheDark':'No', 'submit_time':'2023-11-29T16:56:00.000Z', 'place_1':'Dee', 'place_2':'Bruce', 'place_3':'Jake', 'place_4':'Austin', 'place_5':'Emily', 'place_6':'Katurah', 'place_7':'Julie', 'place_8':'Drew'},
	{'name':'Esme', 'reward':'Austin', 'immunity':'Austin', 'titleQuote':'Jake', 'summit':'Dee', 'nudity':'No', 'idolFound':'No', 'idolPlayed':'Yes', 'shotInTheDark':'No', 'submit_time':'2023-11-29T18:26:00.000Z', 'place_1':'Katurah', 'place_2':'Julie', 'place_3':'Jake', 'place_4':'Austin', 'place_5':'Dee', 'place_6':'Emily', 'place_7':'Bruce', 'place_8':'Drew'},
	{'name':'Betsy', 'reward':'Jake', 'immunity':'Jake', 'titleQuote':'Jake', 'summit':'Emily', 'nudity':'No', 'idolFound':'No', 'idolPlayed':'Yes', 'shotInTheDark':'Yes', 'submit_time':'2023-11-29T18:28:00.000Z', 'place_1':'Austin', 'place_2':'Dee', 'place_3':'Drew', 'place_4':'Julie', 'place_5':'Bruce', 'place_6':'Katurah', 'place_7':'Jake', 'place_8':'Emily'},
	{'name':'Mitch', 'reward':'Austin', 'immunity':'Austin', 'titleQuote':'Drew', 'summit':'Bruce', 'nudity':'No', 'idolFound':'No', 'idolPlayed':'No', 'shotInTheDark':'No', 'submit_time':'2023-11-29T19:29:00.000Z', 'place_1':'Dee', 'place_2':'Katurah', 'place_3':'Jake', 'place_4':'Austin', 'place_5':'Julie', 'place_6':'Drew', 'place_7':'Emily', 'place_8':'Bruce'},
	{'name':'Abby', 'reward':'Katurah', 'immunity':'Drew', 'titleQuote':'Bruce', 'summit':'Drew', 'nudity':'No', 'idolFound':'No', 'idolPlayed':'Yes', 'shotInTheDark':'Yes', 'submit_time':'2023-11-29T20:03:00.000Z', 'place_1':'Drew', 'place_2':'Katurah', 'place_3':'Austin', 'place_4':'Emily', 'place_5':'Jake', 'place_6':'Julie', 'place_7':'Bruce', 'place_8':'Dee'},
	{'name':'Erika', 'reward':'Emily', 'immunity':'Austin', 'titleQuote':'Jake', 'summit':'Julie', 'nudity':'No', 'idolFound':'Yes', 'idolPlayed':'Yes', 'shotInTheDark':'No', 'submit_time':'2023-11-29T20:04:00.000Z', 'place_1':'Dee', 'place_2':'Emily', 'place_3':'Bruce', 'place_4':'Austin', 'place_5':'Jake', 'place_6':'Drew', 'place_7':'Julie', 'place_8':'Katurah'},
	{'name':'Greg', 'reward':'Dee', 'immunity':'Dee', 'titleQuote':'Jake', 'summit':'Bruce', 'nudity':'No', 'idolFound':'No', 'idolPlayed':'Yes', 'shotInTheDark':'No', 'submit_time':'2023-11-29T23:42:00.000Z', 'place_1':'Dee', 'place_2':'Julie', 'place_3':'Katurah', 'place_4':'Drew', 'place_5':'Bruce', 'place_6':'Austin', 'place_7':'Jake', 'place_8':'Emily'},
	{'name':'Anastassia', 'reward':'Bruce', 'immunity':'Bruce', 'titleQuote':'Jake', 'summit':'Jake', 'nudity':'No', 'idolFound':'No', 'idolPlayed':'Yes', 'shotInTheDark':'No', 'submit_time':'2023-11-30T13:16:00.000Z', 'place_1':'Dee', 'place_2':'Julie', 'place_3':'Bruce', 'place_4':'Austin', 'place_5':'Drew', 'place_6':'Katurah', 'place_7':'Emily', 'place_8':'Jake'},
	{'name':'Ethan', 'reward':'Julie', 'immunity':'Julie', 'titleQuote':'Jake', 'summit':'Julie', 'nudity':'No', 'idolFound':'No', 'idolPlayed':'Yes', 'shotInTheDark':'No', 'submit_time':'2023-11-30T13:16:00.000Z', 'place_1':'Dee', 'place_2':'Julie', 'place_3':'Austin', 'place_4':'Drew', 'place_5':'Bruce', 'place_6':'Katurah', 'place_7':'Emily', 'place_8':'Jake'},
	{'name':'Marcy', 'reward':'Julie', 'immunity':'Dee', 'titleQuote':'Jake', 'summit':'Katurah', 'nudity':'No', 'idolFound':'No', 'idolPlayed':'No', 'shotInTheDark':'No', 'submit_time':'2023-11-30T13:16:00.000Z', 'place_1':'Austin', 'place_2':'Emily', 'place_3':'Julie', 'place_4':'Dee', 'place_5':'Drew', 'place_6':'Jake', 'place_7':'Katurah', 'place_8':'Bruce'},
	// WEEK 11
	{'name':'Mitch', 'reward':'Julie', 'immunity':'Drew', 'titleQuote':'Julie', 'summit':'Jake', 'nudity':'No', 'idolFound':'No', 'idolPlayed':'No', 'shotInTheDark':'No', 'submit_time':'2023-12-06T18:32:00.000Z'},
	{'name':'Erika', 'reward':'Emily', 'immunity':'Katurah', 'titleQuote':'Austin', 'summit':'Emily', 'nudity':'No', 'idolFound':'No', 'idolPlayed':'Yes', 'shotInTheDark':'No', 'submit_time':'2023-12-06T19:16:00.000Z'},
	{'name':'Esme', 'reward':'Dee', 'immunity':'Drew', 'titleQuote':'Emily', 'summit':'Dee', 'nudity':'No', 'idolFound':'No', 'idolPlayed':'Yes', 'shotInTheDark':'No', 'submit_time':'2023-12-06T19:37:00.000Z'},
	{'name':'Wilson', 'reward':'Dee', 'immunity':'Emily', 'titleQuote':'Julie', 'summit':'Jake', 'nudity':'No', 'idolFound':'Yes', 'idolPlayed':'Yes', 'shotInTheDark':'No', 'submit_time':'2023-12-06T19:59:00.000Z'},
	{'name':'Christy', 'reward':'Austin', 'immunity':'Austin', 'titleQuote':'Drew', 'summit':'Emily', 'nudity':'No', 'idolFound':'Yes', 'idolPlayed':'No', 'shotInTheDark':'No', 'submit_time':'2023-12-06T20:00:00.000Z'},
	{'name':'Greg', 'reward':'Dee', 'immunity':'Dee', 'titleQuote':'Drew', 'summit':'Jake', 'nudity':'No', 'idolFound':'Yes', 'idolPlayed':'Yes', 'shotInTheDark':'No', 'submit_time':'2023-12-06T20:01:00.000Z'},
	{'name':'Betsy', 'reward':'Austin', 'immunity':'Austin', 'titleQuote':'Julie', 'summit':'Katurah', 'nudity':'No', 'idolFound':'No', 'idolPlayed':'No', 'shotInTheDark':'No', 'submit_time':'2023-12-06T20:02:00.000Z'},
	{'name':'Joe', 'reward':'Katurah', 'immunity':'Dee', 'titleQuote':'Dee', 'summit':'Katurah', 'nudity':'No', 'idolFound':'No', 'idolPlayed':'No', 'shotInTheDark':'No', 'submit_time':'2023-12-06T20:30:00.000Z'},
	{'name':'Abby', 'reward':'Drew', 'immunity':'Drew', 'titleQuote':'Jake', 'summit':'Emily', 'nudity':'No', 'idolFound':'No', 'idolPlayed':'Yes', 'shotInTheDark':'Yes', 'submit_time':'2023-12-06T21:02:00.000Z'},
	{'name':'Anastassia', 'reward':'Emily', 'immunity':'Dee', 'titleQuote':'Austin', 'summit':'Emily', 'nudity':'No', 'idolFound':'No', 'idolPlayed':'No', 'shotInTheDark':'No', 'submit_time':'2023-12-08T20:54:00.000Z'},
	{'name':'Ethan', 'reward':'Austin', 'immunity':'Austin', 'titleQuote':'Julie', 'summit':'Julie', 'nudity':'No', 'idolFound':'No', 'idolPlayed':'Yes', 'shotInTheDark':'No', 'submit_time':'2023-12-08T20:56:00.000Z'},
	{'name':'Marcy', 'reward':'Austin', 'immunity':'Dee', 'titleQuote':'Julie', 'summit':'Drew', 'nudity':'No', 'idolFound':'No', 'idolPlayed':'No', 'shotInTheDark':'No', 'submit_time':'2023-12-08T21:50:00.000Z'},
	// WEEK 12
	{'name':'Joe', 'reward':'Austin', 'immunity':'Dee', 'titleQuote':'Drew', 'summit':'Julie', 'nudity':'No', 'idolFound':'No', 'idolPlayed':'No', 'shotInTheDark':'No', 'submit_time':'2023-12-13T11:40:00.000Z'},
	{'name':'Abby', 'reward':'Jake', 'immunity':'Katurah', 'titleQuote':'Jake', 'summit':'Drew', 'nudity':'No', 'idolFound':'No', 'idolPlayed':'Yes', 'shotInTheDark':'Yes', 'submit_time':'2023-12-13T12:54:00.000Z'},
	{'name':'Christy', 'reward':'Dee', 'immunity':'Dee', 'titleQuote':'Katurah', 'summit':'Drew', 'nudity':'No', 'idolFound':'No', 'idolPlayed':'Yes', 'shotInTheDark':'No', 'submit_time':'2023-12-13T17:48:00.000Z'},
	{'name':'Mitch', 'reward':'Julie', 'immunity':'Julie', 'titleQuote':'Jake', 'summit':'Jake', 'nudity':'No', 'idolFound':'No', 'idolPlayed':'Yes', 'shotInTheDark':'No', 'submit_time':'2023-12-13T18:20:00.000Z'},
	{'name':'Erika', 'reward':'Katurah', 'immunity':'Katurah', 'titleQuote':'Katurah', 'summit':'Jake', 'nudity':'No', 'idolFound':'No', 'idolPlayed':'No', 'shotInTheDark':'No', 'submit_time':'2023-12-13T18:47:00.000Z'},
	{'name':'Betsy', 'reward':'Katurah', 'immunity':'Jake', 'titleQuote':'Jake', 'summit':'Katurah', 'nudity':'No', 'idolFound':'No', 'idolPlayed':'Yes', 'shotInTheDark':'No', 'submit_time':'2023-12-13T19:45:00.000Z'},
	{'name':'Esme', 'reward':'Austin', 'immunity':'Dee', 'titleQuote':'Austin', 'summit':'Julie', 'nudity':'No', 'idolFound':'No', 'idolPlayed':'Yes', 'shotInTheDark':'No', 'submit_time':'2023-12-13T19:58:00.000Z'},
	{'name':'Wilson', 'reward':'Katurah', 'immunity':'Austin', 'titleQuote':'Katurah', 'summit':'Jake', 'nudity':'No', 'idolFound':'Yes', 'idolPlayed':'Yes', 'shotInTheDark':'No', 'submit_time':'2023-12-13T20:02:00.000Z'},
	{'name':'Greg', 'reward':'Dee', 'immunity':'Dee', 'titleQuote':'Drew', 'summit':'Julie', 'nudity':'No', 'idolFound':'No', 'idolPlayed':'Yes', 'shotInTheDark':'No', 'submit_time':'2023-12-13T23:50:00.000Z'},
	{'name':'Ethan', 'reward':'Austin', 'immunity':'Julie', 'titleQuote':'Austin', 'summit':'Julie', 'nudity':'No', 'idolFound':'No', 'idolPlayed':'Yes', 'shotInTheDark':'No', 'submit_time':'2023-12-16T20:47:00.000Z'},
	{'name':'Anastassia', 'reward':'Dee', 'immunity':'Dee', 'titleQuote':'Dee', 'summit':'Dee', 'nudity':'No', 'idolFound':'No', 'idolPlayed':'Yes', 'shotInTheDark':'No', 'submit_time':'2023-12-16T20:48:00.000Z'},
	{'name':'Marcy', 'reward':'Katurah', 'immunity':'Dee', 'titleQuote':'Julie', 'summit':'Katurah', 'nudity':'No', 'idolFound':'No', 'idolPlayed':'Yes', 'shotInTheDark':'No', 'submit_time':'2023-12-17T19:22:00.000Z'},
	// WEEK 13
	{'name':'Esme', 'reward':'Austin', 'immunity_5':'Dee', 'immunity_4':'Julie', 'fireChallenge':'Katurah', 'titleQuote':'Jake', 'summit':'Julie', 'nudity':'No', 'idolFound':'No', 'idolPlayed':'Yes', 'shotInTheDark':'No', 'liveReunion':'Yes', 'submit_time':'2023-12-20T15:54:00.000Z'},
	{'name':'Abby', 'reward':'Katurah', 'immunity_5':'Katurah', 'immunity_4':'Jake', 'fireChallenge':'Jake', 'titleQuote':'Julie', 'summit':'Austin', 'nudity':'No', 'idolFound':'No', 'idolPlayed':'Yes', 'shotInTheDark':'Yes', 'liveReunion':'Yes', 'submit_time':'2023-12-20T16:06:00.000Z'},
	{'name':'Greg', 'reward':'Austin', 'immunity_5':'Dee', 'immunity_4':'Austin', 'fireChallenge':'Austin', 'titleQuote':'Jake', 'summit':'Jake', 'nudity':'No', 'idolFound':'No', 'idolPlayed':'Yes', 'shotInTheDark':'Yes', 'liveReunion':'Yes', 'submit_time':'2023-12-20T16:30:00.000Z'},
	{'name':'Betsy', 'reward':'Austin', 'immunity_5':'Austin', 'immunity_4':'Austin', 'fireChallenge':'Dee', 'titleQuote':'Jake', 'summit':'Austin', 'nudity':'No', 'idolFound':'No', 'idolPlayed':'Yes', 'shotInTheDark':'No', 'liveReunion':'Yes', 'submit_time':'2023-12-20T16:30:00.000Z'},
	{'name':'Mitch', 'reward':'Julie', 'immunity_5':'Austin', 'immunity_4':'Dee', 'fireChallenge':'Katurah', 'titleQuote':'Austin', 'summit':'Katurah', 'nudity':'No', 'idolFound':'No', 'idolPlayed':'Yes', 'shotInTheDark':'No', 'liveReunion':'Yes', 'submit_time':'2023-12-20T17:58:00.000Z'},
	{'name':'Christy', 'reward':'Austin', 'immunity_5':'Austin', 'immunity_4':'Austin', 'fireChallenge':'Katurah', 'titleQuote':'Dee', 'summit':'Katurah', 'nudity':'No', 'idolFound':'No', 'idolPlayed':'Yes', 'shotInTheDark':'No', 'liveReunion':'Yes', 'submit_time':'2023-12-20T18:16:00.000Z'},
	{'name':'Joe', 'reward':'Jake', 'immunity_5':'Austin', 'immunity_4':'Dee', 'fireChallenge':'Austin', 'titleQuote':'Jeff Probst', 'summit':'Jake', 'nudity':'No', 'idolFound':'No', 'idolPlayed':'Yes', 'shotInTheDark':'No', 'liveReunion':'No', 'submit_time':'2023-12-20T19:41:00.000Z'},
	{'name':'Wilson', 'reward':'Katurah', 'immunity_5':'Austin', 'immunity_4':'Julie', 'fireChallenge':'Dee', 'titleQuote':'Jake', 'summit':'Katurah', 'nudity':'No', 'idolFound':'Yes', 'idolPlayed':'Yes', 'shotInTheDark':'No', 'liveReunion':'Yes', 'submit_time':'2023-12-20T19:52:00.000Z'},
	{'name':'Erika', 'reward':'Dee', 'immunity_5':'Austin', 'immunity_4':'Katurah', 'fireChallenge':'Austin', 'titleQuote':'Dee', 'summit':'Julie', 'nudity':'No', 'idolFound':'No', 'idolPlayed':'Yes', 'shotInTheDark':'No', 'liveReunion':'No', 'submit_time':'2023-12-20T20:02:00.000Z'},
	{'name':'Anastassia', 'reward':'Julie', 'immunity_5':'Julie', 'immunity_4':'Dee', 'fireChallenge':'Katurah', 'titleQuote':'Jake', 'summit':'Austin', 'nudity':'No', 'idolFound':'No', 'idolPlayed':'Yes', 'shotInTheDark':'No', 'liveReunion':'Yes', 'submit_time':'2023-12-21T20:43:00.000Z'},
	{'name':'Ethan', 'reward':'Austin', 'immunity_5':'Austin', 'immunity_4':'Katurah', 'fireChallenge':'Dee', 'titleQuote':'Dee', 'summit':'Jake', 'nudity':'No', 'idolFound':'No', 'idolPlayed':'Yes', 'shotInTheDark':'No', 'liveReunion':'Yes', 'submit_time':'2023-12-21T20:45:00.000Z'},
	{'name':'Marcy', 'reward':'Katurah', 'immunity_5':'Austin', 'immunity_4':'Dee', 'fireChallenge':'Julie', 'titleQuote':'Jeff Probst', 'summit':'Julie', 'nudity':'No', 'idolFound':'No', 'idolPlayed':'No', 'shotInTheDark':'No', 'liveReunion':'Yes', 'submit_time':'2023-12-25T14:44:00.000Z'}
];