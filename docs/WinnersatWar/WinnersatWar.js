...
function PushPullGithub(form_results) {
    ...
    $.ajax({
        type: "GET",
        url: "https://api.github.com/repos/ethanebinger/Fantasy-Survivor/contents/docs/WinnersatWar/WinnersatWar_Responses.json",
        dataType: "json",
            ...
            api.setBranch('master')
                .then( () => api.pushFiles(
                    ...
                    [{
                        ...
                        path: 'docs/WinnersatWar/WinnersatWar_Responses.json'
                    }]
                ))
                .then(function() {
                    console.log('Files committed!');
                    window.location = "http://ethanebinger.com/Fantasy-Survivor/WinnersatWar/results.html"
                });
        }
    });
};
...
function init_chart() {
    ...
    $.when(
        ...
        $.get("https://api.github.com/repos/ethanebinger/Fantasy-Survivor/contents/docs/WinnersatWar/WinnersatWar_Responses.json", function(result) {
